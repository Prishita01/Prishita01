...
MS Computer Science (AI/ML), Case Western Reserve University. I build ML systems that run end-to-end in production including models, data pipelines, infra, and monitoring that keep them working.
